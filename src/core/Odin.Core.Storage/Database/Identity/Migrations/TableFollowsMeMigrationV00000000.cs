...
namespace Odin.Core.Storage.Database.Identity.Table
{
    public class TableFollowsMeMigrationV0 : MigrationBase
    {
        ...
        public TableFollowsMeMigrationV0(MigrationListBase container) : base(container)
        {
        }
        ...
        public virtual async Task<int> EnsureTableExistsAsync(IConnectionWrapper cn, bool dropExisting = false)
        {
            ...
            if (dropExisting)
            {
                cmd.CommandText = "DROP TABLE IF EXISTS FollowsMeMigrationsV0;";
            ...
            var wori = "";
            cmd.CommandText =
                "CREATE TABLE IF NOT EXISTS FollowsMeMigrationsV0("
                   +rowid
