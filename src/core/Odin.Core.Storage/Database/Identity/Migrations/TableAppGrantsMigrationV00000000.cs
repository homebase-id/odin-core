...
namespace Odin.Core.Storage.Database.Identity.Table
{
    public class TableAppGrantsMigrationV0 : MigrationBase
    {
        ...
        public TableAppGrantsMigrationV0(MigrationListBase container) : base(container)
        {
        }
        ...
        public virtual async Task<int> EnsureTableExistsAsync(IConnectionWrapper cn, bool dropExisting = false)
        {
            ...
            if (dropExisting)
            {
                cmd.CommandText = "DROP TABLE IF EXISTS AppGrantsMigrationsV0;";
            ...
            var wori = "";
            cmd.CommandText =
                "CREATE TABLE IF NOT EXISTS AppGrantsMigrationsV0("
                   +rowid
        ...
        public async Task<int> CopyDataAsync(IConnectionWrapper cn)
        {
            ...
            {
                copyCommand.CommandText = "INSERT INTO AppGrantsMigrationsV0 (rowId,identityId,odinHashId,appId,circleId,data) " +
