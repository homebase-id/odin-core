...
namespace Odin.Core.Storage.Database.Identity.Table
{
    public class TableDriveAclIndexMigrationV0 : MigrationBase
    {
        ...
        public TableDriveAclIndexMigrationV0(MigrationListBase container) : base(container)
        {
        }
        ...
        public virtual async Task<int> EnsureTableExistsAsync(IConnectionWrapper cn, bool dropExisting = false)
        {
            ...
            if (dropExisting)
            {
                cmd.CommandText = "DROP TABLE IF EXISTS DriveAclIndexMigrationsV0;";
            ...
            var wori = "";
            cmd.CommandText =
                "CREATE TABLE IF NOT EXISTS DriveAclIndexMigrationsV0("
                   +rowid
