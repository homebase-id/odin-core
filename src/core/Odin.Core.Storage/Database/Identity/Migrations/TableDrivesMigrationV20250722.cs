...
{
    public class TableDrivesMigrationV20250722 : MigrationBase
    {
        public override int MigrationVersion => 20250722;
        public TableDrivesMigrationV20250722(MigrationListBase container) : base(container)
        {
        }
        ...
        public virtual async Task<int> EnsureTableExistsAsync(IConnectionWrapper cn, bool dropExisting = false)
        {
            ...
            if (dropExisting)
            {
                cmd.CommandText = "DROP TABLE IF EXISTS DrivesMigrationsV20250722;";
            ...
            var wori = "";
            cmd.CommandText =
                "CREATE TABLE IF NOT EXISTS DrivesMigrationsV20250722("
                   +rowid
        ...
        public async Task<int> CopyDataAsync(IConnectionWrapper cn)
        {
            ...
            {
                copyCommand.CommandText = "INSERT INTO DrivesMigrationsV20250722 (rowId,identityId,DriveId,DriveAlias,TempOriginalDriveId,DriveType,DriveName,MasterKeyEncryptedStorageKeyJson,EncryptedIdIv64,EncryptedIdValue64,detailsJson,created,modified) " +
        ...
        // Will upgrade from the previous version to version 20250722
        public override async Task UpAsync(IConnectionWrapper cn)
        {
            try
            {
                using (var trn = await cn.BeginStackedTransactionAsync())
                {
                    ...
                    if (await VerifyRowCount(cn, "Drives", "DrivesMigrationsV20250722") == false)
                    ...
                    await RenameAsync(cn, "DrivesMigrationsV20250722", "Drives");
                    trn.Commit();
                }
            }
            catch
        ...
        public override async Task DownAsync(IConnectionWrapper cn)
        {
            try
            {
                using (var trn = await cn.BeginStackedTransactionAsync())
                {
                    ...
                    await RenameAsync(cn, "Drives", "DrivesMigrationsV20250722");
