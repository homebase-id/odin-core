...
namespace Odin.Core.Storage.Database.Identity.Table
{
    public class TableAppGrantsMigrationV0 : MigrationBase
    {
        ...
        public TableAppGrantsMigrationV0(Int64 previousVersion) : base(previousVersion)
        {
        }
        ...
        {
            if (dropExisting)
                await MigrationBase.DeleteTableAsync(cn, "AppGrantsMigrationsV0");
            var rowid = "";
            var commentSql = "";
            ...
            var wori = "";
            string createSql =
                "CREATE TABLE AppGrantsMigrationsV0( -- { \"Version\": 0 }\n"
                   +rowid
