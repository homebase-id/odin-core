...
namespace Odin.Core.Storage.Database.Identity.Table
{
    ...
    public class TableDriveTransferHistoryOldCRUD
    {
        private readonly ScopedIdentityConnectionFactory _scopedConnectionFactory;

        public TableDriveTransferHistoryOldCRUD(CacheHelper cache, ScopedIdentityConnectionFactory scopedConnectionFactory)
        {
