...
#pragma warning restore CS0168
        ...
        protected virtual async Task<List<CircleMemberRecord>> GetCircleMembersAsync(Guid identityId,Guid circleId)
        {
            ...
            {
                get0Command.CommandText = "SELECT memberId,data FROM circleMember " +
...
#pragma warning restore CS0168
        ...
        protected virtual async Task<List<CircleMemberRecord>> GetMemberCirclesAndDataAsync(Guid identityId,Guid memberId)
        {
            ...
            {
                get1Command.CommandText = "SELECT circleId,data FROM circleMember " +
        ...
        protected CircleMemberRecord ReadRecordFromReader2(DbDataReader rdr)
        {
            var result = new List<CircleMemberRecord>();
#pragma warning disable CS0168
            long bytesRead;
#pragma warning restore CS0168
        ...
        protected virtual async Task<List<CircleMemberRecord>> GetAllAsync()
        {
            await using var cn = await _scopedConnectionFactory.CreateScopedConnectionAsync();
            await using var get2Command = cn.CreateCommand();
            {
                get2Command.CommandText = "SELECT identityId,circleId,memberId,data FROM circleMember " +
                                             ";";
...
#pragma warning restore CS0168
        ...
        protected virtual async Task<CircleMemberRecord> GetAsync(Guid identityId,Guid circleId,Guid memberId)
        {
            ...
            {
                get3Command.CommandText = "SELECT data FROM circleMember " +
