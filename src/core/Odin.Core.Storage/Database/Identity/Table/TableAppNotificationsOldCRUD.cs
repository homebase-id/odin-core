...
namespace Odin.Core.Storage.Database.Identity.Table
{
    ...
    public class TableAppNotificationsOldCRUD
    {
        private readonly CacheHelper _cache;
        private readonly ScopedIdentityConnectionFactory _scopedConnectionFactory;

        public TableAppNotificationsOldCRUD(CacheHelper cache, ScopedIdentityConnectionFactory scopedConnectionFactory)
        {
            _cache = cache;
