...
namespace Odin.Core.Storage.Database.Identity.Table
{
    ...
    public class TableDriveLocalTagIndexOldCRUD
    {
        private readonly ScopedIdentityConnectionFactory _scopedConnectionFactory;

        public TableDriveLocalTagIndexOldCRUD(CacheHelper cache, ScopedIdentityConnectionFactory scopedConnectionFactory)
        {
