...
namespace Odin.Core.Storage.Database.Identity.Table
{
    public record AppGrantsRecord
    {
        ...
        public Guid odinHashId
        {
           ...
           set {
                    value.AssertGuidNotEmpty("Guid parameter odinHashId cannot be set to Empty GUID.");
                  _odinHashId = value;
               }
        }
        private Guid _appId;
        public Guid appId
        {
           ...
           set {
                    value.AssertGuidNotEmpty("Guid parameter appId cannot be set to Empty GUID.");
                  _appId = value;
               }
        }
