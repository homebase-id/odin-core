...
namespace Odin.Core.Storage.Database.Identity.Table
{
    ...
    public abstract class TableDriveTagIndexCRUD : AbstractTable
    {
        private readonly ScopedIdentityConnectionFactory _scopedConnectionFactory;

        protected TableDriveTagIndexCRUD(CacheHelper cache, ScopedIdentityConnectionFactory scopedConnectionFactory) : base(scopedConnectionFactory)
        {
        ...
        protected virtual async Task<int> InsertAsync(DriveTagIndexRecord item)
        {
            ...
            await using var insertCommand = cn.CreateCommand();
            {
                ...
                insertParam4.Value = item.tagId.Cast(_scopedConnectionFactory.DatabaseType);
        ...
        protected virtual async Task<int> UpsertAsync(DriveTagIndexRecord item)
        {
            ...
            await using var upsertCommand = cn.CreateCommand();
            {
                ...
                upsertParam4.Value = item.tagId.Cast(_scopedConnectionFactory.DatabaseType);
        ...
        protected virtual async Task<int> UpdateAsync(DriveTagIndexRecord item)
        {
            ...
            await using var updateCommand = cn.CreateCommand();
            {
                ...
                updateParam4.Value = item.tagId.Cast(_scopedConnectionFactory.DatabaseType);
...
#pragma warning restore CS0168
        ...
        protected virtual async Task<int> DeleteAsync(Guid identityId,Guid driveId,Guid fileId,Guid tagId)
        {
            ...
            await using var delete0Command = cn.CreateCommand();
            {
                ...
                delete0Param4.Value = tagId.Cast(_scopedConnectionFactory.DatabaseType);
...
#pragma warning restore CS0168
        ...
        protected virtual async Task<DriveTagIndexRecord> GetAsync(Guid identityId,Guid driveId,Guid fileId,Guid tagId)
        {
            ...
            await using var get0Command = cn.CreateCommand();
            {
                ...
                get0Param4.Value = tagId.Cast(_scopedConnectionFactory.DatabaseType);
                {
