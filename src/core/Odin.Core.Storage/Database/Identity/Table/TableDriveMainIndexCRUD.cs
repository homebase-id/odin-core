    ...
    public class DriveMainIndexRecord
    {
        ...
        public string hdrAppData
        {
           ...
           set {
                    if (value == null) throw new Exception("Cannot be null");
                    if (value?.Length < 0) throw new Exception("Too short");
                    if (value?.Length > 10240) throw new Exception("Too long");
                  _hdrAppData = value;
               }
        }
...
#pragma warning restore CS0168
            ...
            item.globalTransitId = rdr.IsDBNull(3) ? null : new Guid((byte[])rdr[3]);
            item.fileState = rdr.IsDBNull(4) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[4];
            item.requiredSecurityGroup = rdr.IsDBNull(5) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[5];
            item.fileSystemType = rdr.IsDBNull(6) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[6];
            item.userDate = rdr.IsDBNull(7) ? throw new Exception("item is NULL, but set as NOT NULL") : new UnixTimeUtc((long)rdr[7]);
            item.fileType = rdr.IsDBNull(8) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[8];
            item.dataType = rdr.IsDBNull(9) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[9];
            item.archivalStatus = rdr.IsDBNull(10) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[10];
            item.historyStatus = rdr.IsDBNull(11) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[11];
            item.senderIdNoLengthCheck = rdr.IsDBNull(12) ? null : (string)rdr[12];
            item.groupId = rdr.IsDBNull(13) ? null : new Guid((byte[])rdr[13]);
            item.uniqueId = rdr.IsDBNull(14) ? null : new Guid((byte[])rdr[14]);
            item.byteCount = rdr.IsDBNull(15) ? throw new Exception("item is NULL, but set as NOT NULL") : (long)rdr[15];
            item.hdrEncryptedKeyHeaderNoLengthCheck = rdr.IsDBNull(16) ? throw new Exception("item is NULL, but set as NOT NULL") : (string)rdr[16];
            item.hdrVersionTag = rdr.IsDBNull(17) ? throw new Exception("item is NULL, but set as NOT NULL") : new Guid((byte[])rdr[17]);
            item.hdrAppDataNoLengthCheck = rdr.IsDBNull(18) ? throw new Exception("item is NULL, but set as NOT NULL") : (string)rdr[18];
            item.hdrLocalVersionTag = rdr.IsDBNull(19) ? null : new Guid((byte[])rdr[19]);
            item.hdrLocalAppDataNoLengthCheck = rdr.IsDBNull(20) ? null : (string)rdr[20];
            item.hdrReactionSummaryNoLengthCheck = rdr.IsDBNull(21) ? null : (string)rdr[21];
            item.hdrServerDataNoLengthCheck = rdr.IsDBNull(22) ? throw new Exception("item is NULL, but set as NOT NULL") : (string)rdr[22];
            item.hdrTransferHistoryNoLengthCheck = rdr.IsDBNull(23) ? null : (string)rdr[23];
            item.hdrFileMetaDataNoLengthCheck = rdr.IsDBNull(24) ? throw new Exception("item is NULL, but set as NOT NULL") : (string)rdr[24];
            item.hdrTmpDriveAlias = rdr.IsDBNull(25) ? throw new Exception("item is NULL, but set as NOT NULL") : new Guid((byte[])rdr[25]);
            item.hdrTmpDriveType = rdr.IsDBNull(26) ? throw new Exception("item is NULL, but set as NOT NULL") : new Guid((byte[])rdr[26]);
            item.created = rdr.IsDBNull(27) ? throw new Exception("item is NULL, but set as NOT NULL") : new UnixTimeUtcUnique((long)rdr[27]);
            item.modified = rdr.IsDBNull(28) ? null : new UnixTimeUtcUnique((long)rdr[28]);
            return item;
       }
...
#pragma warning restore CS0168
            ...
            item.fileId = rdr.IsDBNull(0) ? throw new Exception("item is NULL, but set as NOT NULL") : new Guid((byte[])rdr[0]);
            item.globalTransitId = rdr.IsDBNull(1) ? null : new Guid((byte[])rdr[1]);
            item.fileState = rdr.IsDBNull(2) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[2];
            item.requiredSecurityGroup = rdr.IsDBNull(3) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[3];
            item.fileSystemType = rdr.IsDBNull(4) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[4];
            item.userDate = rdr.IsDBNull(5) ? throw new Exception("item is NULL, but set as NOT NULL") : new UnixTimeUtc((long)rdr[5]);
            item.fileType = rdr.IsDBNull(6) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[6];
            item.dataType = rdr.IsDBNull(7) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[7];
            item.archivalStatus = rdr.IsDBNull(8) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[8];
            item.historyStatus = rdr.IsDBNull(9) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[9];
            item.senderIdNoLengthCheck = rdr.IsDBNull(10) ? null : (string)rdr[10];
            item.groupId = rdr.IsDBNull(11) ? null : new Guid((byte[])rdr[11]);
            item.byteCount = rdr.IsDBNull(12) ? throw new Exception("item is NULL, but set as NOT NULL") : (long)rdr[12];
            item.hdrEncryptedKeyHeaderNoLengthCheck = rdr.IsDBNull(13) ? throw new Exception("item is NULL, but set as NOT NULL") : (string)rdr[13];
            item.hdrVersionTag = rdr.IsDBNull(14) ? throw new Exception("item is NULL, but set as NOT NULL") : new Guid((byte[])rdr[14]);
            item.hdrAppDataNoLengthCheck = rdr.IsDBNull(15) ? throw new Exception("item is NULL, but set as NOT NULL") : (string)rdr[15];
            item.hdrLocalVersionTag = rdr.IsDBNull(16) ? null : new Guid((byte[])rdr[16]);
            item.hdrLocalAppDataNoLengthCheck = rdr.IsDBNull(17) ? null : (string)rdr[17];
            item.hdrReactionSummaryNoLengthCheck = rdr.IsDBNull(18) ? null : (string)rdr[18];
            item.hdrServerDataNoLengthCheck = rdr.IsDBNull(19) ? throw new Exception("item is NULL, but set as NOT NULL") : (string)rdr[19];
            item.hdrTransferHistoryNoLengthCheck = rdr.IsDBNull(20) ? null : (string)rdr[20];
            item.hdrFileMetaDataNoLengthCheck = rdr.IsDBNull(21) ? throw new Exception("item is NULL, but set as NOT NULL") : (string)rdr[21];
            item.hdrTmpDriveAlias = rdr.IsDBNull(22) ? throw new Exception("item is NULL, but set as NOT NULL") : new Guid((byte[])rdr[22]);
            item.hdrTmpDriveType = rdr.IsDBNull(23) ? throw new Exception("item is NULL, but set as NOT NULL") : new Guid((byte[])rdr[23]);
            item.created = rdr.IsDBNull(24) ? throw new Exception("item is NULL, but set as NOT NULL") : new UnixTimeUtcUnique((long)rdr[24]);
            item.modified = rdr.IsDBNull(25) ? null : new UnixTimeUtcUnique((long)rdr[25]);
            return item;
       }
...
#pragma warning restore CS0168
            ...
            item.fileId = rdr.IsDBNull(0) ? throw new Exception("item is NULL, but set as NOT NULL") : new Guid((byte[])rdr[0]);
            item.fileState = rdr.IsDBNull(1) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[1];
            item.requiredSecurityGroup = rdr.IsDBNull(2) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[2];
            item.fileSystemType = rdr.IsDBNull(3) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[3];
            item.userDate = rdr.IsDBNull(4) ? throw new Exception("item is NULL, but set as NOT NULL") : new UnixTimeUtc((long)rdr[4]);
            item.fileType = rdr.IsDBNull(5) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[5];
            item.dataType = rdr.IsDBNull(6) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[6];
            item.archivalStatus = rdr.IsDBNull(7) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[7];
            item.historyStatus = rdr.IsDBNull(8) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[8];
            item.senderIdNoLengthCheck = rdr.IsDBNull(9) ? null : (string)rdr[9];
            item.groupId = rdr.IsDBNull(10) ? null : new Guid((byte[])rdr[10]);
            item.uniqueId = rdr.IsDBNull(11) ? null : new Guid((byte[])rdr[11]);
            item.byteCount = rdr.IsDBNull(12) ? throw new Exception("item is NULL, but set as NOT NULL") : (long)rdr[12];
            item.hdrEncryptedKeyHeaderNoLengthCheck = rdr.IsDBNull(13) ? throw new Exception("item is NULL, but set as NOT NULL") : (string)rdr[13];
            item.hdrVersionTag = rdr.IsDBNull(14) ? throw new Exception("item is NULL, but set as NOT NULL") : new Guid((byte[])rdr[14]);
            item.hdrAppDataNoLengthCheck = rdr.IsDBNull(15) ? throw new Exception("item is NULL, but set as NOT NULL") : (string)rdr[15];
...
#pragma warning restore CS0168
            ...
            item.senderIdNoLengthCheck = rdr.IsDBNull(10) ? null : (string)rdr[10];
            item.groupId = rdr.IsDBNull(11) ? null : new Guid((byte[])rdr[11]);
            item.uniqueId = rdr.IsDBNull(12) ? null : new Guid((byte[])rdr[12]);
            item.byteCount = rdr.IsDBNull(13) ? throw new Exception("item is NULL, but set as NOT NULL") : (long)rdr[13];
            item.hdrEncryptedKeyHeaderNoLengthCheck = rdr.IsDBNull(14) ? throw new Exception("item is NULL, but set as NOT NULL") : (string)rdr[14];
            item.hdrVersionTag = rdr.IsDBNull(15) ? throw new Exception("item is NULL, but set as NOT NULL") : new Guid((byte[])rdr[15]);
            item.hdrAppDataNoLengthCheck = rdr.IsDBNull(16) ? throw new Exception("item is NULL, but set as NOT NULL") : (string)rdr[16];
            item.hdrLocalVersionTag = rdr.IsDBNull(17) ? null : new Guid((byte[])rdr[17]);
            item.hdrLocalAppDataNoLengthCheck = rdr.IsDBNull(18) ? null : (string)rdr[18];
            item.hdrReactionSummaryNoLengthCheck = rdr.IsDBNull(19) ? null : (string)rdr[19];
            item.hdrServerDataNoLengthCheck = rdr.IsDBNull(20) ? throw new Exception("item is NULL, but set as NOT NULL") : (string)rdr[20];
            item.hdrTransferHistoryNoLengthCheck = rdr.IsDBNull(21) ? null : (string)rdr[21];
            item.hdrFileMetaDataNoLengthCheck = rdr.IsDBNull(22) ? throw new Exception("item is NULL, but set as NOT NULL") : (string)rdr[22];
            item.hdrTmpDriveAlias = rdr.IsDBNull(23) ? throw new Exception("item is NULL, but set as NOT NULL") : new Guid((byte[])rdr[23]);
            item.hdrTmpDriveType = rdr.IsDBNull(24) ? throw new Exception("item is NULL, but set as NOT NULL") : new Guid((byte[])rdr[24]);
            item.created = rdr.IsDBNull(25) ? throw new Exception("item is NULL, but set as NOT NULL") : new UnixTimeUtcUnique((long)rdr[25]);
            item.modified = rdr.IsDBNull(26) ? null : new UnixTimeUtcUnique((long)rdr[26]);
            return item;
       }
...
#pragma warning restore CS0168
            ...
            item.driveId = driveId;
            item.fileId = fileId;
            item.globalTransitId = rdr.IsDBNull(0) ? null : new Guid((byte[])rdr[0]);
            item.fileState = rdr.IsDBNull(1) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[1];
            item.requiredSecurityGroup = rdr.IsDBNull(2) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[2];
            item.fileSystemType = rdr.IsDBNull(3) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[3];
            item.userDate = rdr.IsDBNull(4) ? throw new Exception("item is NULL, but set as NOT NULL") : new UnixTimeUtc((long)rdr[4]);
