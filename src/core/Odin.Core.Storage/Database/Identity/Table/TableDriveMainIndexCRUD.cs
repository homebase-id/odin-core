        ...
        protected virtual async Task<int> UpsertAsync(DriveMainIndexRecord item)
        {
            ...
            await using var upsertCommand = cn.CreateCommand();
            {
                ...
                upsertCommand.CommandText = "INSERT INTO DriveMainIndex (identityId,driveId,fileId,globalTransitId,fileState,requiredSecurityGroup,fileSystemType,userDate,fileType,dataType,archivalStatus,historyStatus,senderId,groupId,uniqueId,byteCount,hdrEncryptedKeyHeader,hdrVersionTag,hdrAppData,hdrLocalVersionTag,hdrLocalAppData,hdrReactionSummary,hdrServerData,hdrTransferHistory,hdrFileMetaData,hdrTmpDriveAlias,hdrTmpDriveType,created,modified) " +
                                            ...
                                            $"SET DriveMainIndex.globalTransitId = @globalTransitId,DriveMainIndex.fileState = @fileState,DriveMainIndex.requiredSecurityGroup = @requiredSecurityGroup,DriveMainIndex.fileSystemType = @fileSystemType,DriveMainIndex.userDate = @userDate,DriveMainIndex.fileType = @fileType,DriveMainIndex.dataType = @dataType,DriveMainIndex.archivalStatus = @archivalStatus,DriveMainIndex.historyStatus = @historyStatus,DriveMainIndex.senderId = @senderId,DriveMainIndex.groupId = @groupId,DriveMainIndex.uniqueId = @uniqueId,DriveMainIndex.byteCount = @byteCount,DriveMainIndex.hdrEncryptedKeyHeader = @hdrEncryptedKeyHeader,DriveMainIndex.hdrVersionTag = @hdrVersionTag,DriveMainIndex.hdrAppData = @hdrAppData,DriveMainIndex.hdrLocalVersionTag = @hdrLocalVersionTag,DriveMainIndex.hdrLocalAppData = @hdrLocalAppData,DriveMainIndex.hdrReactionSummary = @hdrReactionSummary,DriveMainIndex.hdrServerData = @hdrServerData,DriveMainIndex.hdrTransferHistory = @hdrTransferHistory,DriveMainIndex.hdrFileMetaData = @hdrFileMetaData,DriveMainIndex.hdrTmpDriveAlias = @hdrTmpDriveAlias,DriveMainIndex.hdrTmpDriveType = @hdrTmpDriveType,DriveMainIndex.modified = {SqlExtensions.MaxString(_scopedConnectionFactory.DatabaseType)}(DriveMainIndex.modified+1,{sqlNowStr}) "+
                                            "RETURNING DriveMainIndex.created,DriveMainIndex.modified,DriveMainIndex.rowId;";
