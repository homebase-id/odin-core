...
namespace Odin.Core.Storage.Database.Identity.Table
{
    public record DriveMainIndexRecord
    {
        ...
        public void Validate()
        {
            ...
            hdrVersionTag.AssertGuidNotEmpty("Guid parameter identityId cannot be set to Empty GUID.");
            ...
            hdrTmpDriveAlias.AssertGuidNotEmpty("Guid parameter identityId cannot be set to Empty GUID.");
            hdrTmpDriveType.AssertGuidNotEmpty("Guid parameter identityId cannot be set to Empty GUID.");
        }
