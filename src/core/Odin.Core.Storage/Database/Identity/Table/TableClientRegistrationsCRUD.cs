        ...
        *
        public override async Task EnsureTableExistsAsync(bool dropExisting = false)
        {
            ...
            if (cn.DatabaseType == DatabaseType.Postgres)
            {
               ...
               commentSql = "COMMENT ON TABLE ClientRegistrations IS '{ \"Version\": 202510201056 }';";
            }
            else
               rowid = "rowId INTEGER PRIMARY KEY AUTOINCREMENT,";
            var wori = "";
            string createSql =
                "CREATE TABLE IF NOT EXISTS ClientRegistrations( -- { \"Version\": 202510201056 }\n"
                   +rowid
       ...
       */
        ...
        protected virtual async Task<int> InsertAsync(ClientRegistrationsRecord item)
        {
            ...
            await using var insertCommand = cn.CreateCommand();
            {
                ...
                insertCommand.AddParameter("@ttl", DbType.Int32, item.ttl);
        ...
        protected virtual async Task<int> UpsertAsync(ClientRegistrationsRecord item)
        {
            ...
            await using var upsertCommand = cn.CreateCommand();
            {
                ...
                upsertCommand.AddParameter("@ttl", DbType.Int32, item.ttl);
        ...
        protected virtual async Task<int> UpdateAsync(ClientRegistrationsRecord item)
        {
            ...
            await using var updateCommand = cn.CreateCommand();
            {
                ...
                updateCommand.AddParameter("@ttl", DbType.Int32, item.ttl);
...
#pragma warning restore CS0168
            ...
            item.ttl = (rdr[4] == DBNull.Value) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[4];
...
#pragma warning restore CS0168
            ...
            item.ttl = (rdr[3] == DBNull.Value) ? throw new Exception("item is NULL, but set as NOT NULL") : (int)(long)rdr[3];
...
#pragma warning restore CS0168
        ...
        protected virtual async Task<(List<ClientRegistrationsRecord>, Int64? nextCursor)> PagingByRowIdAsync(int count, Guid identityId, Int64? inCursor)
        {
            if (count < 1)
                throw new Exception("Count must be at least 1.");
            if (count == int.MaxValue)
