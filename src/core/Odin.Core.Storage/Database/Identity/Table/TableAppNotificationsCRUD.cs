...
namespace Odin.Core.Storage.Database.Identity.Table
{
    ...
    public abstract class TableAppNotificationsCRUD : AbstractTable
    {
        private readonly CacheHelper _cache;
        private readonly ScopedIdentityConnectionFactory _scopedConnectionFactory;

        protected TableAppNotificationsCRUD(CacheHelper cache, ScopedIdentityConnectionFactory scopedConnectionFactory) : base(scopedConnectionFactory)
        {
            _cache = cache;
        ...
        public override async Task EnsureTableExistsAsync(bool dropExisting = false)
        {
            ...
            if (_scopedConnectionFactory.DatabaseType == DatabaseType.Sqlite)
            {
                cmd.CommandText =
                   ...
                   +"notificationId STRING NOT NULL UNIQUE, "
                   +"unread INT NOT NULL, "
                   +"senderId STRING , "
        ...
        protected virtual async Task<int> InsertAsync(AppNotificationsRecord item)
        {
            ...
            await using var insertCommand = cn.CreateCommand();
            {
                ...
                insertParam2.Value = item.notificationId.Cast(_scopedConnectionFactory.DatabaseType);
        ...
        protected virtual async Task<int> UpsertAsync(AppNotificationsRecord item)
        {
            ...
            await using var upsertCommand = cn.CreateCommand();
            {
                ...
                upsertParam2.Value = item.notificationId.Cast(_scopedConnectionFactory.DatabaseType);
        ...
        protected virtual async Task<int> UpdateAsync(AppNotificationsRecord item)
        {
            ...
            await using var updateCommand = cn.CreateCommand();
            {
                ...
                updateParam2.Value = item.notificationId.Cast(_scopedConnectionFactory.DatabaseType);
...
#pragma warning restore CS0168
        ...
        protected virtual async Task<int> DeleteAsync(Guid identityId,Guid notificationId)
        {
            ...
            await using var delete0Command = cn.CreateCommand();
            {
                ...
                delete0Param2.Value = notificationId.Cast(_scopedConnectionFactory.DatabaseType);
...
#pragma warning restore CS0168
        ...
        protected virtual async Task<AppNotificationsRecord> GetAsync(Guid identityId,Guid notificationId)
        {
            ...
            await using var get0Command = cn.CreateCommand();
            {
                ...
                get0Param2.Value = notificationId.Cast(_scopedConnectionFactory.DatabaseType);
                {
