...
#pragma warning restore CS0168
        ...
        public virtual async Task<(List<RegistrationsRecord>, Int64? nextCursor)> PagingByRowIdAsync(int count, Int64? inCursor)
        {
            ...
            {
                getPaging0Command.CommandText = "SELECT rowId,identityId,email,primaryDomainName,firstRunToken,disabled,markedForDeletionDate,planId,json,created,modified FROM Registrations " +
