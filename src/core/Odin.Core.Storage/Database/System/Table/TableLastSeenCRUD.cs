...
#pragma warning restore CS0168
        ...
        public virtual async Task<(List<LastSeenRecord>, Int64? nextCursor)> PagingByRowIdAsync(int count, Int64? inCursor)
        {
            if (count < 1)
            ...
            {
                getPaging0Command.CommandText = "SELECT rowId,subject,timestamp FROM LastSeen " +
