...
#pragma warning restore CS0168
        ...
        public virtual async Task<(List<SettingsRecord>, Int64? nextCursor)> PagingByRowIdAsync(int count, Int64? inCursor)
        {
            if (count < 1)
            ...
            {
                getPaging0Command.CommandText = "SELECT rowId,key,value,created,modified FROM Settings " +
