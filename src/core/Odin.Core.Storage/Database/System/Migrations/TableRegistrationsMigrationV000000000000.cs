...
{
    public TableRegistrationsMigrationV0(long previousVersion) : base(previousVersion)
    {
    }
    ...
    public override async Task CreateTableWithCommentAsync(IConnectionWrapper cn)
    {
        ...
        var createSql =
                ...
                + $"){wori};"
            ;
        await SqlHelper.CreateTableWithCommentAsync(cn, "RegistrationsMigrationsV0", createSql, commentSql);
    }
    ...
    public async Task<int> CopyDataAsync(IConnectionWrapper cn)
    {
        ...
        await using var copyCommand = cn.CreateCommand();
        {
            copyCommand.CommandText =
                "INSERT INTO RegistrationsMigrationsV0 (rowId,identityId,email,primaryDomainName,firstRunToken,disabled,markedForDeletionDate,planId,json,created,modified) " +
    ...
    public override async Task UpAsync(IConnectionWrapper cn)
    {
        using (var trn = await cn.BeginStackedTransactionAsync())
        {
            ...
            await SqlHelper.RenameAsync(cn, "RegistrationsMigrationsV0", "Registrations");
            trn.Commit();
        }
    }
