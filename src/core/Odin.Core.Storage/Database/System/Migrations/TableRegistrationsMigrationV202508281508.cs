...
namespace Odin.Core.Storage.Database.System.Migrations
{
    public class TableRegistrationsMigrationV202508281508 : MigrationBase
    {
        ...
        public async Task<int> CopyDataAsync(IConnectionWrapper cn)
        {
            ...
            {
                copyCommand.CommandText = "INSERT INTO RegistrationsMigrationsV202508281508 (rowId,identityId,email,primaryDomainName,firstRunToken,disabled,markedForDeletionDate,planId,lastSeen,json,created,modified) " +
