...
{
    public TableRegistrationsMigrationV202509090509(long previousVersion) : base(previousVersion)
    {
    }

    public override long MigrationVersion => 202509090509;
    ...
    public async Task<int> CopyDataAsync(IConnectionWrapper cn)
    {
        ...
        await using var copyCommand = cn.CreateCommand();
        {
            copyCommand.CommandText =
                "INSERT INTO RegistrationsMigrationsV202509090509 (rowId,identityId,email,primaryDomainName,firstRunToken,disabled,markedForDeletionDate,planId,json,created,modified) " +
    ...
    public override async Task UpAsync(IConnectionWrapper cn)
    {
        ...
        using (var trn = await cn.BeginStackedTransactionAsync())
        {
            ...
            if (!await VerifyRowCount(cn, "Registrations", "RegistrationsMigrationsV202509090509"))
