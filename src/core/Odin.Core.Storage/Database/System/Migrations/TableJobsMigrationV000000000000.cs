...
{
    public TableJobsMigrationV0(long previousVersion) : base(previousVersion)
    {
    }
    ...
    public override async Task CreateTableWithCommentAsync(IConnectionWrapper cn)
    {
        ...
        var wori = "";
        var createSql =
                "CREATE TABLE IF NOT EXISTS JobsMigrationsV0( -- { \"Version\": 0 }\n"
                + rowid
    ...
    public async Task<int> CopyDataAsync(IConnectionWrapper cn)
    {
        ...
        await using var copyCommand = cn.CreateCommand();
        {
            copyCommand.CommandText =
                "INSERT INTO JobsMigrationsV0 (rowId,id,name,state,priority,nextRun,lastRun,runCount,maxAttempts,retryDelay,onSuccessDeleteAfter,onFailureDeleteAfter,expiresAt,correlationId,jobType,jobData,jobHash,lastError,created,modified) " +
