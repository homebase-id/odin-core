...
// THIS FILE IS AUTO GENERATED 2024-10-17T08:51:14.6577442Z - DO NOT EDIT
...
namespace Odin.Core.Storage.SQLite.IdentityDatabase
{
    ...
    public class TableInboxCRUD : TableBase
    {
        ...
        internal virtual async Task<int> InsertAsync(DatabaseConnection conn, InboxRecord item)
        {
            ...
            DatabaseBase.AssertGuidNotEmpty(item.boxId, "Guid parameter boxId cannot be set to Empty GUID.");
            DatabaseBase.AssertGuidNotEmpty(item.popStamp, "Guid parameter popStamp cannot be set to Empty GUID.");
