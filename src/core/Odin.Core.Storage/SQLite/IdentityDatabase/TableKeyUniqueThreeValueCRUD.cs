...
namespace Odin.Core.Storage.SQLite.IdentityDatabase
{
    ...
    public class TableKeyUniqueThreeValueCRUD : TableBase
    {
        ...
        public virtual int Insert(DatabaseConnection conn, KeyUniqueThreeValueRecord item)
        {
        ...
        public virtual int TryInsert(DatabaseConnection conn, KeyUniqueThreeValueRecord item)
        {
            using (var _insertCommand = _database.CreateCommand())
            {
                _insertCommand.CommandText = "INSERT OR IGNORE INTO keyUniqueThreeValue (key1,key2,key3,data) " +
                                             "VALUES (@key1,@key2,@key3,@data)";
                var _insertParam1 = _insertCommand.CreateParameter();
                _insertParam1.ParameterName = "@key1";
                _insertCommand.Parameters.Add(_insertParam1);
        ...
        public virtual int Upsert(DatabaseConnection conn, KeyUniqueThreeValueRecord item)
        {
        ...
        public virtual int Update(DatabaseConnection conn, KeyUniqueThreeValueRecord item)
        {
        ...
        public KeyUniqueThreeValueRecord ReadRecordFromReaderAll(SqliteDataReader rdr)
        {
...
#pragma warning restore CS0168
        ...
        public KeyUniqueThreeValueRecord ReadRecordFromReader2(SqliteDataReader rdr, byte[] key2,byte[] key3)
        {
            if (key2 == null) throw new Exception("Cannot be null");
            if (key2?.Length < 0) throw new Exception("Too short");
            if (key2?.Length > 256) throw new Exception("Too long");
...
#pragma warning restore CS0168
        ...
        public List<KeyUniqueThreeValueRecord> GetByKeyTwoThree(DatabaseConnection conn, byte[] key2,byte[] key3)
        {
            if (key2 == null) throw new Exception("Cannot be null");
            if (key2?.Length < 0) throw new Exception("Too short");
            if (key2?.Length > 256) throw new Exception("Too long");
        ...
        public KeyUniqueThreeValueRecord ReadRecordFromReader3(SqliteDataReader rdr, byte[] key1)
        {
            if (key1 == null) throw new Exception("Cannot be null");
            if (key1?.Length < 16) throw new Exception("Too short");
            if (key1?.Length > 48) throw new Exception("Too long");
...
#pragma warning restore CS0168
        ...
        public KeyUniqueThreeValueRecord Get(DatabaseConnection conn, byte[] key1)
        {
            if (key1 == null) throw new Exception("Cannot be null");
            if (key1?.Length < 16) throw new Exception("Too short");
            if (key1?.Length > 48) throw new Exception("Too long");
