...
namespace Odin.Core.Storage.SQLite.ServerDatabase
{
    public class JobsRecord
    {
        ...
        private UnixTimeUtc _onFailedDeleteAfter;
        public UnixTimeUtc onFailedDeleteAfter
        {
           get {
                   return _onFailedDeleteAfter;
               }
           set {
                  _onFailedDeleteAfter = value;
               }
        }
    ...
    public class TableJobsCRUD : TableBase
    {
        ...
        public sealed override void EnsureTableExists(DatabaseConnection conn, bool dropExisting = false)
        {
                using (var cmd = _database.CreateCommand())
                {
                    ...
                    "CREATE TABLE IF NOT EXISTS jobs("
                     ...
                     +"onFailedDeleteAfter INT NOT NULL, "
        ...
        public virtual int Insert(DatabaseConnection conn, JobsRecord item)
        {
                ...
                {
                    _insertCommand.CommandText = "INSERT INTO jobs (id,state,priority,nextRun,lastRun,runCount,maxRuns,onSuccessDeleteAfter,onFailedDeleteAfter,correlationId,inputType,inputData,inputHash,outputType,outputData,created,modified) " +
                                                 "VALUES ($id,$state,$priority,$nextRun,$lastRun,$runCount,$maxRuns,$onSuccessDeleteAfter,$onFailedDeleteAfter,$correlationId,$inputType,$inputData,$inputHash,$outputType,$outputData,$created,$modified)";
                    ...
                    _insertParam9.ParameterName = "$onFailedDeleteAfter";
                ...
                _insertParam5.Value = item.lastRun.milliseconds;
                ...
                _insertParam9.Value = item.onFailedDeleteAfter.milliseconds;
        ...
        public virtual int TryInsert(DatabaseConnection conn, JobsRecord item)
        {
            using (var _insertCommand = _database.CreateCommand())
            {
                _insertCommand.CommandText = "INSERT OR IGNORE INTO jobs (id,state,priority,nextRun,lastRun,runCount,maxRuns,onSuccessDeleteAfter,onFailedDeleteAfter,correlationId,inputType,inputData,inputHash,outputType,outputData,created,modified) " +
                                             "VALUES (@id,@state,@priority,@nextRun,@lastRun,@runCount,@maxRuns,@onSuccessDeleteAfter,@onFailedDeleteAfter,@correlationId,@inputType,@inputData,@inputHash,@outputType,@outputData,@created,@modified)";
                var _insertParam1 = _insertCommand.CreateParameter();
                _insertParam1.ParameterName = "@id";
                _insertCommand.Parameters.Add(_insertParam1);
        ...
        public virtual int Upsert(DatabaseConnection conn, JobsRecord item)
        {
                ...
                {
                    _upsertCommand.CommandText = "INSERT INTO jobs (id,state,priority,nextRun,lastRun,runCount,maxRuns,onSuccessDeleteAfter,onFailedDeleteAfter,correlationId,inputType,inputData,inputHash,outputType,outputData,created) " +
                                                 "VALUES ($id,$state,$priority,$nextRun,$lastRun,$runCount,$maxRuns,$onSuccessDeleteAfter,$onFailedDeleteAfter,$correlationId,$inputType,$inputData,$inputHash,$outputType,$outputData,$created)"+
                                                 "ON CONFLICT (id) DO UPDATE "+
                                                 "SET state = $state,priority = $priority,nextRun = $nextRun,lastRun = $lastRun,runCount = $runCount,maxRuns = $maxRuns,onSuccessDeleteAfter = $onSuccessDeleteAfter,onFailedDeleteAfter = $onFailedDeleteAfter,correlationId = $correlationId,inputType = $inputType,inputData = $inputData,inputHash = $inputHash,outputType = $outputType,outputData = $outputData,modified = $modified "+
                    ...
                    _upsertParam9.ParameterName = "$onFailedDeleteAfter";
                ...
                _upsertParam5.Value = item.lastRun.milliseconds;
                ...
                _upsertParam9.Value = item.onFailedDeleteAfter.milliseconds;
        ...
        public virtual int Update(DatabaseConnection conn, JobsRecord item)
        {
                using (var _updateCommand = _database.CreateCommand())
                {
                    ...
                    _updateParam9.ParameterName = "$onFailedDeleteAfter";
                ...
                _updateParam5.Value = item.lastRun.milliseconds;
                ...
                _updateParam9.Value = item.onFailedDeleteAfter.milliseconds;
        ...
        // SELECT id,state,priority,nextRun,lastRun,runCount,maxRuns,onSuccessDeleteAfter,onFailedDeleteAfter,correlationId,inputType,inputData,inputHash,outputType,outputData,created,modified
...
#pragma warning restore CS0168
            ...
            {
                item.onFailedDeleteAfter = new UnixTimeUtc(rdr.GetInt64(8));
            }
...
#pragma warning restore CS0168
            ...
            {
                item.onFailedDeleteAfter = new UnixTimeUtc(rdr.GetInt64(7));
            }
        ...
        public JobsRecord Get(DatabaseConnection conn, Guid id)
        {
                ...
                {
                    _get0Command.CommandText = "SELECT state,priority,nextRun,lastRun,runCount,maxRuns,onSuccessDeleteAfter,onFailedDeleteAfter,correlationId,inputType,inputData,inputHash,outputType,outputData,created,modified FROM jobs " +
                                                 "WHERE id = $id LIMIT 1;";
