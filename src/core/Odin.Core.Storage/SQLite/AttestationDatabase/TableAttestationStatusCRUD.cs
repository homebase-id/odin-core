...
// THIS FILE IS AUTO GENERATED 2024-10-17T08:51:14.6465868Z - DO NOT EDIT
...
namespace Odin.Core.Storage.SQLite.AttestationDatabase
{
    ...
    public class TableAttestationStatusCRUD : TableBase
    {
        ...
        public TableAttestationStatusCRUD(CacheHelper cache) : base("attestationStatus")
        {
            _cache = cache;
        }
...
#pragma warning restore CS0168
            ...
            else
            {
                ...
                Buffer.BlockCopy(tmpbuf, 0, item.attestationId, 0, (int) bytesRead);
            }
