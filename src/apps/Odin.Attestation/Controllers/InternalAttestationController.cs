...
public class InternalAttestationController : ControllerBase
{
    ...
    private async Task<ActionResult> DeleteRequest(string nonceBase64)
    {
        try
        {
            var n = await _db.AttestationRequest.DeleteAsync(nonceBase64);
    ...
    public async Task<ActionResult> GetInvalidateAttestation(string attestationIdBase64)
    {
        ...
        await _db.AttestationStatus.UpdateAsync(r);
    ...
    public async Task<ActionResult> GetApproveRequest(string attestationIdBase64)
    {
        ...
        //
        var r = await _db.AttestationRequest.GetAsync(attestationIdBase64);
        ...
        await _db.AttestationStatus.InsertAsync(record);
    ...
    {
        var (r, nextCursor) = await _db.AttestationRequest.PagingByAttestationIdAsync(100, null);
