...
[Description("Disable tenant public web presence (public home page)")]
public sealed class DisablePublicWebPresenceCommand : AsyncCommand<DisablePublicWebPresenceCommand.Settings>
{
    ...
    public override async Task<int> ExecuteAsync([NotNull] CommandContext context, [NotNull] Settings settings)
    {
        ...
        var response = await httpClient.PatchAsync($"tenants/{settings.TenantDomain}/public-web-presence/disable", null);
