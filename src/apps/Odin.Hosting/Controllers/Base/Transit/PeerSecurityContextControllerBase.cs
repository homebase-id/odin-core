...
namespace Odin.Hosting.Controllers.Base.Transit
{
    ...
    /// </summary>
    public abstract class PeerSecurityContextControllerBase(PeerDriveOutgoingQueryService peerDriveOutgoingQueryService) : OdinControllerBase
    {
        ...
        public async Task<RedactedOdinContext> GetRemoteDotYouContext([FromBody] TransitGetSecurityContextRequest request)
        {
            ...
            var ctx = await peerDriveOutgoingQueryService.GetRemoteDotYouContextAsync((OdinId)request.OdinId,WebOdinContext);
            return ctx;
        }
    }
}
