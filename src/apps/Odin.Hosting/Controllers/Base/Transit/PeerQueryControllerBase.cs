...
namespace Odin.Hosting.Controllers.Base.Transit
{
    ...
    /// </summary>
    public abstract class PeerQueryControllerBase(OutgoingPeerDriveQueryService outgoingPeerDriveQueryService) : OdinControllerBase
    {
        ...
        public async Task<QueryBatchCollectionResponse> GetBatchCollection([FromBody] PeerQueryBatchCollectionRequest request)
        {
            ...
            var result = await outgoingPeerDriveQueryService.GetBatchCollectionAsync(id, request, GetHttpFileSystemResolver().GetFileSystemType(), WebOdinContext);
            return result;
        }
        ...
        public async Task<QueryModifiedResponse> GetModified([FromBody] PeerQueryModifiedRequest request)
        {
            ...
            var result = await outgoingPeerDriveQueryService.GetModifiedAsync(id, request, GetHttpFileSystemResolver().GetFileSystemType(), WebOdinContext);
        ...
        public async Task<QueryBatchResponse> QueryBatch([FromBody] PeerQueryBatchRequest request)
        {
            ...
            var batch = await outgoingPeerDriveQueryService.GetBatchAsync(id, request, GetHttpFileSystemResolver().GetFileSystemType(), WebOdinContext);
        ...
        public async Task<IActionResult> GetFileHeader([FromBody] TransitExternalFileIdentifier request)
        {
            ...
            SharedSecretEncryptedFileHeader result =
                await outgoingPeerDriveQueryService.GetFileHeaderAsync(id, request.File, GetHttpFileSystemResolver().GetFileSystemType(), WebOdinContext);
        ...
        public async Task<IActionResult> GetPayloadStream([FromBody] TransitGetPayloadRequest request)
        {
            ...
            var (encryptedKeyHeader, isEncrypted, payloadStream) = await outgoingPeerDriveQueryService.GetPayloadStreamAsync(id,
        ...
        public async Task<IActionResult> GetThumbnail([FromBody] TransitGetThumbRequest request)
        {
            ...
            var (encryptedKeyHeader, isEncrypted, decryptedContentType, lastModified, thumb) =
                await outgoingPeerDriveQueryService.GetThumbnailAsync(id, request.File, request.Width, request.Height,
                    request.PayloadKey,
        ...
        public async Task<PagedResult<ClientDriveData>> GetDrivesByType([FromBody] TransitGetDrivesByTypeRequest request)
        {
            ...
            var drives = await outgoingPeerDriveQueryService.GetDrivesByTypeAsync((OdinId)request.OdinId, request.DriveType, GetHttpFileSystemResolver().GetFileSystemType(),
                WebOdinContext);
            ...
            [FromQuery] Guid type)
        {
            ...
            var result = await outgoingPeerDriveQueryService.GetFileHeaderByGlobalTransitIdAsync(id, file, fst, WebOdinContext);
            ...
            [FromQuery] int? chunkStart, [FromQuery] int? chunkLength)
        {
            ...
            var (encryptedKeyHeader, isEncrypted, payloadStream) =
                await outgoingPeerDriveQueryService.GetPayloadByGlobalTransitIdAsync(id, file, key, chunk, fst, WebOdinContext);
            ...
            [FromQuery] string payloadKey)
        {
            ...
            var (encryptedKeyHeader, isEncrypted, decryptedContentType, lastModified, thumb) =
                await outgoingPeerDriveQueryService.GetThumbnailByGlobalTransitIdAsync(id, file, payloadKey, width, height, directMatchOnly, fst, WebOdinContext);
            ...
            [FromQuery] Guid type)
        {
            ...
            var result = await outgoingPeerDriveQueryService.GetFileHeaderByUniqueIdAsync(id, file, fst, WebOdinContext);
