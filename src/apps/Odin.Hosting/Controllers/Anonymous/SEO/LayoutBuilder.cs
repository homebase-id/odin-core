...
public static class LayoutBuilder
{
        ...
        IOdinContext odinContext)
    {
        ...
        b.AppendLine($"<meta property='og:url' content='{displayUrl}'/>");
        ...
        // Canonical
        b.AppendLine($"<link rel='canonical' href='{displayUrl}' />");
    ...
    private static string GetDisplayUrl(HttpContext httpContext)
    {
