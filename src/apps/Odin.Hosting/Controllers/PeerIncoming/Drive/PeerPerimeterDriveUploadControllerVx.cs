...
/// <summary>
/// Batch update feature for files which lets you perform multiple operations in one http request (i.e. update header, delete payload, append new payload)
/// </summary>
[ApiController]
[Route(PeerApiPathConstants.DriveV1)]
[Authorize(Policy = PeerPerimeterPolicies.IsInOdinNetwork, AuthenticationSchemes = PeerAuthConstants.TransitCertificateAuthScheme)]
public class PeerIncomingDriveUpdateControllerVx : OdinControllerBase
{
    ...
    /// <summary />
    public PeerIncomingDriveUpdateControllerVx(DriveManager driveManager,
