...
namespace Odin.Hosting.Controllers.OwnerToken.Membership.YouAuth
{
    ...
    public class YouAuthDomainRegistrationController : OdinControllerBase
    {
        ...
        {
            var domains = await _registrationService.GetRegisteredDomains(TheOdinContext);
            return domains;
        }
        ...
        {
            var reg = await _registrationService.GetRegistration(new AsciiDomainName(request.Domain), TheOdinContext);
            if (null == reg)
            {
                return NotFound();
            }
        ...
        {
            var reg = await _registrationService.RegisterDomain(request, TheOdinContext);
            return reg;
        }
        ...
        {
            await _registrationService.GrantCircle(request.CircleId, new AsciiDomainName(request.Domain), TheOdinContext);
            return true;
        }
        ...
        {
            await _registrationService.RevokeCircleAccess(request.CircleId, new AsciiDomainName(request.Domain), TheOdinContext);
            return true;
        }
        ...
        {
            await _registrationService.RevokeDomain(new AsciiDomainName(request.Domain), TheOdinContext);
            return Ok();
        }
        ...
        {
            await _registrationService.RemoveDomainRevocation(new AsciiDomainName(request.Domain), TheOdinContext);
            return Ok();
        }
        ...
        {
            await _registrationService.DeleteDomainRegistration(new AsciiDomainName(request.Domain), TheOdinContext);
            return Ok();
        }
        ...
        {
            var result = await _registrationService.GetRegisteredClients(new AsciiDomainName(domain), TheOdinContext);
            return result;
        }
        ...
        {
            await _registrationService.DeleteClient(request.AccessRegistrationId, TheOdinContext);
        }
        ...
        public async Task<YouAuthDomainClientRegistrationResponse> RegisterClient([FromBody] YouAuthDomainClientRegistrationRequest request)
        {
            ...
            var (token, _) = await _registrationService.RegisterClient(new AsciiDomainName(request.Domain), request.ClientFriendlyName, null, TheOdinContext);
