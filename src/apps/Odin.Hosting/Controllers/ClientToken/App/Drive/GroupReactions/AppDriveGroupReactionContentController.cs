...
namespace Odin.Hosting.Controllers.ClientToken.App.Drive.GroupReactions
{
    ...
    public class AppDriveGroupReactionContentController : OdinControllerBase
    {
        ...
        /// <summary />
        public AppDriveGroupReactionContentController(GroupReactionService groupReactionService, TenantSystemStorage tenantSystemStorage)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> AddReactionContent([FromBody] AddReactionRequestRedux request)
        {
            using var cn = _tenantSystemStorage.CreateConnection();

            await _groupReactionService.AddReaction(request.File, request.Reaction, request.TransitOptions, WebOdinContext, cn,
        ...
        [SwaggerOperation(Tags = [SwaggerSection])]
        [HttpDelete]
        public async Task<IActionResult> DeleteReactionContent([FromBody] DeleteReactionRequestRedux request)
        {
            using var cn = _tenantSystemStorage.CreateConnection();

            await _groupReactionService.DeleteReaction(request.File, request.Reaction, request.TransitOptions, WebOdinContext, cn,
                this.GetHttpFileSystemResolver().GetFileSystemType());
