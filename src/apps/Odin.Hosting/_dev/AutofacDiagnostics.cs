...
public class AutofacDiagnostics(IContainer root, ILogger logger)
{
    ...
    private readonly Dictionary<Type, string> _manualCheckSingletonWhitelist = new()
    {
        ...
        {typeof(Odin.Core.Identity.OdinIdentity), "7ddb7f9c"},
        ...
        {typeof(Odin.Services.Email.IEmailSender), "5a48691d;08d9f9e3;75b1a8d0;9f30ad3c"}, // 4th: SmtpSender
        ...
        {typeof(Odin.Services.Certificate.CertificateService), "543207cd"},
        ...
        {typeof(Odin.Services.Drives.DriveCore.Storage.UploadFileStore), "5b81378a"},
        {typeof(Odin.Services.Drives.DriveCore.Storage.InboxFileStore), "5b81378a"},
        {typeof(Odin.Services.Drives.DriveCore.Storage.LongTermPayloadStore), "5b81378a"},
    };
