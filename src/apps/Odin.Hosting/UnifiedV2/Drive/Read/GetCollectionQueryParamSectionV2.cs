...
public class GetCollectionQueryParamSectionV2 {
    ...
    public CollectionQueryParamSectionV2 ToCollectionQueryParamSection () {
        return new CollectionQueryParamSectionV2() {
            Name = this.Name,
            ...
            ResultOptionsRequest = new QueryBatchResultOptionsRequestV2() {
