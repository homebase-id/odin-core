...
/// <summary>
/// Deep-link fallback for the statically-served Kotlin/WASM chat app. The app registers its own
...
/// e.g. <c>/apps/chat/conversations/frodo.dotyou.cloud</c> — still resolve to the shell.
/// </summary>
