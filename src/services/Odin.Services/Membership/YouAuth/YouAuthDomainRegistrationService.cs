...
namespace Odin.Services.Membership.YouAuth
{
    public class YouAuthDomainRegistrationService
    {
        ...
        /// </summary>
        public async Task<RedactedYouAuthDomainRegistration> RegisterDomain(YouAuthDomainRegistrationRequest request, IOdinContext odinContext, IdentityDatabase db)
        {
            ...
            var grants = await _circleMembershipService.CreateCircleGrantList(request.CircleIds ?? new List<GuidId>(), keyStoreKey, odinContext, db);
        ...
        public async Task UpdateConsentRequirements(AsciiDomainName domain, ConsentRequirements consentRequirements, IOdinContext odinContext, IdentityDatabase db)
        {
            odinContext.Caller.AssertHasMasterKey();
        ...
        public async Task GrantCircle(GuidId circleId, AsciiDomainName domainName, IOdinContext odinContext, IdentityDatabase db)
        {
            ...
            var circleGrant = await _circleMembershipService.CreateCircleGrant(circleDefinition, keyStoreKey, masterKey, odinContext, db);
