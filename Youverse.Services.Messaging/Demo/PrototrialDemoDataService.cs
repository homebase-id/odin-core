...
namespace Youverse.Services.Messaging.Demo
{
    public class PrototrialDemoDataService : IPrototrialDemoDataService
    {
        ...
        public PrototrialDemoDataService(DotYouContext context, ILogger<IPrototrialDemoDataService> logger, IProfileService profileService, IOwnerDataAttributeManagementService adminAttributeManagementService, ICircleNetworkRequestService circleNetworkService)
        {
            ...
            _adminAttributeManagementService = adminAttributeManagementService;
            _circleNetworkService = circleNetworkService;
        }

        public async Task<bool> AddContacts()
        {
            // if (IsFrodo)
            // {
        ...
        public async Task SetProfiles()
        {
            ...
            ProfilePicAttribute profilePic = null;
            TwitterAttribute twitter = null;
            BasicProfileInfo publicProfileInfo = null;
            BasicProfileInfo privateProfileInfo = null;
            ...
            if (IsSam)
            {
                ...
                twitter = new TwitterAttribute() {Twitter = "@samwise"};
            ...
            if (IsGandalf)
            {
                ...
                twitter = new TwitterAttribute() {Twitter = "@graybeard"};
                profilePic = new ProfilePicAttribute()
                {
            ...
            if (IsOdin)
            {
                ...
                twitter = new TwitterAttribute() {Twitter = "@odinone"};
                profilePic = new ProfilePicAttribute()
                {
