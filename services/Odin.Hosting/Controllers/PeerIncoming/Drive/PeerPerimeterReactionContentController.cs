...
namespace Odin.Hosting.Controllers.PeerIncoming.Drive
{
    ...
    {
        private readonly PeerReactionService _reactionService;

        public PeerPerimeterReactionContentController(PeerReactionService reactionService)
        {
        ...
        {
            await _reactionService.AddReaction(payload);
            return NoContent();
        }
        ...
        {
            await _reactionService.DeleteAllReactions(payload);
            return NoContent();
        }
        ...
        {
            return await _reactionService.GetReactionCountsByFile(payload);
        }
        ...
        {
            return await _reactionService.GetReactionsByIdentityAndFile(payload);
        }
    }
}