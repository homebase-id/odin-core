...
public class AppCircleDefinitionTests
{
    ...
    public async Task AppCannotSeeSystemCircleMembers()
    {
        ...
        var appClient = await this.PrepareAppAndClient(TestIdentities.Frodo, PermissionKeys.All.ToArray());
    ...
    public async Task AppCanGetCircleMembers()
    {
        ...
        var appClient = await this.PrepareAppAndClient(identity, PermissionKeys.ReadCircleMembership);
    ...
    public async Task AppFailsToGetCircleMembersWithoutReadCircleMembershipPermission()
    {
        ...
        var appClient = await this.PrepareAppAndClient(identity, PermissionKeys.ReadConnections);
    ...
    public async Task AppFailsToGetCircleDefinitionWithoutReadCircleMembershipPermission()
    {
        ...
        var appClient = await this.PrepareAppAndClient(identity);
