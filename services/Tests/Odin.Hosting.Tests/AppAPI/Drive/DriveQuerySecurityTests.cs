...
namespace Odin.Hosting.Tests.AppAPI.Drive
{
    public class DriveQuerySecurityTests
    {
        ...
        [Test]
        public async Task QueryBatchReturnsAvailableResults_EvenWhenNoAccessToSomeFilesInResultSet()
        {
            ...
            var header2 = await UploadStandardRandomFileHeadersUsingOwnerApi(identity, appDrive1.TargetDriveInfo);
            var header3 = await UploadStandardRandomFileHeadersUsingOwnerApi(identity, appDrive1.TargetDriveInfo);
