...
public class UnifiedCryptoTest
{
    ...
    public void CryptoFlowTest()
    {
        ...
        // Request CLIENT -> HOST
        var queryStringClientPublicKey = clientKeyPair.publicDerBase64();
        ...
        var remoteClientPublicKey = EccPublicKeyData.FromDerEncodedPublicKey(Convert.FromBase64String(queryStringClientPublicKey));
        ...
        var responseHostPublicKey = hostKeyPair.publicDerBase64();
        var responseHostSalt = Convert.ToBase64String(hostSalt);

        //
        // CLIENT
        //
        var remoteHostPublicKey = EccPublicKeyData.FromDerEncodedPublicKey(Convert.FromBase64String(responseHostPublicKey));
