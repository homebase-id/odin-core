...
//
//         public LetsEncryptTenantCertificateRenewalService(
//             ILogger<LetsEncryptTenantCertificateRenewalService> logger, 
//             TenantContext tenantContext,
//             ITenantCertificateService tenantCertificateService, 
//             PendingCertificateOrderListService certificateOrderList, 
...
//             
//             // SEB:TODO loop here until AuthorizationStatus.Valid
//             
...
//             var cert = await context.Download();
//
//             //
...
//             if (_tenantContext.CertificateRenewalConfig.UseCertificateAuthorityProductionServers)
//             {
//                 certificatePem = cert.ToPem();
//             }
//             else
//             {
...
//
//                 foreach (var rootPemFile in _config.CertificateRenewal.LetsEncryptStagingRootCertificates)
//                 {
//                     var path = Path.Combine(AppContext.BaseDirectory, rootPemFile);
//                     _logger.LogDebug("Adding root certicate at {path}", path);
//                     var root = await File.ReadAllBytesAsync(path);
//                     pfxBuilder.AddIssuer(root);                    
//                 }
//             
//                 var pfx = pfxBuilder.Build(csr.CommonName, "doesnt-matter");
//             
...
//                     sb.AppendLine(Convert.ToBase64String(element.Certificate.Export(X509ContentType.Cert), Base64FormattingOptions.InsertLineBreaks));
//                     sb.AppendLine("-----END CERTIFICATE-----");
//                 }
//                 certificatePem = sb.ToString();
//             }
//             
