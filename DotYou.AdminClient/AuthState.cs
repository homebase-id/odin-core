...
namespace DotYou.AdminClient
{
    public class AuthState
    {
        ...
        public static IPasswordReply PreparePassword<T>(string password, ClientNoncePackage noncePackage) where T :IPasswordReply, new()
        {
            ...
            using var rfc = new Rfc2898DeriveBytes(passwordBytes, Convert.FromBase64String(noncePackage.SaltPassword64), CryptographyConstants.ITERATIONS, HashAlgorithmName.SHA512);
            hashPassword = rfc.GetBytes(CryptographyConstants.HASH_SIZE);
            Console.WriteLine($"did you work? {hashPassword}");
            return null;

            // var noncePassword = KeyDerivation.Pbkdf2(Convert.ToBase64String(hashPassword), Convert.FromBase64String(noncePackage.Nonce64), KeyDerivationPrf.HMACSHA512, CryptographyConstants.ITERATIONS, CryptographyConstants.HASH_SIZE);
            // var keyEncryptionKey = KeyDerivation.Pbkdf2(password, Convert.FromBase64String(noncePackage.SaltKek64), KeyDerivationPrf.HMACSHA512, CryptographyConstants.ITERATIONS, CryptographyConstants.HASH_SIZE);
            //
            // var clientReply = new T()
            // {
            ...
            //     HashedPassword64 = Convert.ToBase64String(hashPassword)
            // };
            //
            // return clientReply;
        }
        ...
        public async Task<bool> Login(string password)
        {
            ...
            var clientReply = PreparePassword<AuthenticationNonceReply>(password, noncePackage);
