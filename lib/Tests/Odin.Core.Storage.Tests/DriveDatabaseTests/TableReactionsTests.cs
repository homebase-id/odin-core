...
namespace Odin.Core.Storage.Tests.DriveDatabaseTests
{
    ...
    public class TableReactions
    {
        ...
        public void ExampleUsageTest()
        {
            ...
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("frodo.baggins.me"), postId = p1, singleReaction = ":lol:" });
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("frodo.baggins.me"), postId = p1, singleReaction = ":wink:" });
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("bilbo.baggins.me"), postId = p1, singleReaction = ":lol:" });
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("bilbo.baggins.me"), postId = p1, singleReaction = ":wink:" });
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("sam.gamgee.me"), postId = p1, singleReaction = ":lol:" });
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("sam.gamgee.me"), postId = p1, singleReaction = ":smiley:" });
        ...
        public void IdentityPostDetailsTest()
        {
            ...
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("frodo.baggins.me"), postId = k1, singleReaction = ":lol:" });
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("frodo.baggins.me"), postId = k1, singleReaction = ":wink:" });
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("frodo.baggins.me"), postId = k1, singleReaction = ":smile:" });
        ...
        public void InsertDuplicateFailTest()
        {
            ...
            try
            {
                ...
                db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("frodo.baggins.me"), postId = k1, singleReaction = ":l" });
                ok = false;
            }
            catch
            {
            ...
            try
            {
                ...
                db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId(new string('a', 257)), postId = k1, singleReaction = ":lol:" });
                ok = false;
            }
            catch
            {
        ...
        public void GetPostReactionstest()
        {
            ...
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("frodo.baggins.me"), postId = k1, singleReaction = ":wink:" });
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("bilbo.baggins.me"), postId = k1, singleReaction = ":lol:" });
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("bilbo.baggins.me"), postId = k1, singleReaction = ":wink:" });
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("sam.gamgee.me"), postId = k1, singleReaction = ":lol:" });
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("sam.gamgee.me"), postId = k1, singleReaction = ":smiley:" });
        ...
        public void GetPostReactionsChopTest()
        {
            ...
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("sam.gamgee.me"), postId = k1, singleReaction = ":lol:" });
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("sam.gamgee.me"), postId = k1, singleReaction = ":smiley:" });
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("sam.gamgee.me"), postId = k1, singleReaction = ":skull:" });
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("sam.gamgee.me"), postId = k1, singleReaction = ":wagon:" });
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("sam.gamgee.me"), postId = k1, singleReaction = ":heart:" });
            db.TblReactions.Insert(new ReactionsRecord { identity = new OdinId("sam.gamgee.me"), postId = k1, singleReaction = ":cat:" });
