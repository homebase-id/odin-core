...
namespace Odin.Core.Storage.Tests.IdentityDatabaseTests
{
    ...
    public class TableReactions
    {
        ...
        public void ExampleUsageTest()
        {
            ...
            db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId("frodo.baggins.me"), postId = p1, singleReaction = ":lol:" });
            db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId("frodo.baggins.me"), postId = p1, singleReaction = ":wink:" });
            db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId("bilbo.baggins.me"), postId = p1, singleReaction = ":lol:" });
            db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId("bilbo.baggins.me"), postId = p1, singleReaction = ":wink:" });
            db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId("sam.gamgee.me"), postId = p1, singleReaction = ":lol:" });
            db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId("sam.gamgee.me"), postId = p1, singleReaction = ":smiley:" });
            ...
            Int32? cursor = 0;
            var r2 = db.tblDriveReactions.PagingByRowid(5, cursor, out cursor, driveId, p1);
            Debug.Assert(r2.Count == 5);
            Debug.Assert(cursor != null);

            r2 = db.tblDriveReactions.PagingByRowid(5, cursor, out cursor, driveId, p1);
        ...
        public void InsertDuplicateFailTest()
        {
            ...
            try
            {
                ...
                db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId("frodo.baggins.me"), postId = k1, singleReaction = ":l" });
                ok = false;
            }
            catch
            {
            ...
            try
            {
                ...
                db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId(new string('a', 257)), postId = k1, singleReaction = ":lol:" });
                ok = false;
            }
            catch
            {
        ...
        public void GetPostReactionstest()
        {
            ...
            db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId("frodo.baggins.me"), postId = k1, singleReaction = ":wink:" });
            db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId("bilbo.baggins.me"), postId = k1, singleReaction = ":lol:" });
            db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId("bilbo.baggins.me"), postId = k1, singleReaction = ":wink:" });
            db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId("sam.gamgee.me"), postId = k1, singleReaction = ":lol:" });
            db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId("sam.gamgee.me"), postId = k1, singleReaction = ":smiley:" });
        ...
        public void GetPostReactionsChopTest()
        {
            ...
            db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId("sam.gamgee.me"), postId = k1, singleReaction = ":lol:" });
            db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId("sam.gamgee.me"), postId = k1, singleReaction = ":smiley:" });
            db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId("sam.gamgee.me"), postId = k1, singleReaction = ":skull:" });
            db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId("sam.gamgee.me"), postId = k1, singleReaction = ":wagon:" });
            db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId("sam.gamgee.me"), postId = k1, singleReaction = ":heart:" });
            db.tblDriveReactions.Insert(new DriveReactionsRecord { driveId = driveId, identity = new OdinId("sam.gamgee.me"), postId = k1, singleReaction = ":cat:" });
