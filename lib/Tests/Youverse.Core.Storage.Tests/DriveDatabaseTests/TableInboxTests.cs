...
namespace IndexerTests.KeyValue
{
    public class TableInboxTests
    {
        ...
        public void PopCancelTest()
        {
            ...
            db.tblInbox.InsertRow(boxid.ToByteArray(), f1.ToByteArray(), 0, null);
            db.tblInbox.InsertRow(boxid.ToByteArray(), f2.ToByteArray(), 0, null);
            db.tblInbox.InsertRow(boxid.ToByteArray(), f3.ToByteArray(), 10, null);
            db.tblInbox.InsertRow(boxid.ToByteArray(), f4.ToByteArray(), 10, null);
            db.tblInbox.InsertRow(boxid.ToByteArray(), f5.ToByteArray(), 20, null);

            var r1 = db.tblInbox.Pop(boxid.ToByteArray(), 2, out var popTimestamp1);
            var r2 = db.tblInbox.Pop(boxid.ToByteArray(), 3, out var popTimestamp2);

            db.tblInbox.PopCancel(popTimestamp1);

            var r3 = db.tblInbox.Pop(boxid.ToByteArray(), 10, out var popTimestamp3);
            ...
            var r4 = db.tblInbox.Pop(boxid.ToByteArray(), 10, out var popTimestamp4);
        ...
        public void PopCommitTest()
        {
            ...
            var r2 = db.tblInbox.Pop(boxid.ToByteArray(), 10, out var popTimestamp2);
            if (r2.Count != 3)
                Assert.Fail();
        }
        ...
        public void DualBoxTest()
        {
            ...
            var b2 = SequentialGuid.CreateGuid().ToByteArray();
