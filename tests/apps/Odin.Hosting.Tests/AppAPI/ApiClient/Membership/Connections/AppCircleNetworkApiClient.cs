...
public class AppCircleNetworkApiClient : AppApiClientBase
{
    private readonly AppClientToken _token;

    public AppCircleNetworkApiClient(OwnerApiTestUtils ownerApiTestUtils, AppClientToken token) : base(ownerApiTestUtils)
    {
        _token = token;
    }
