...
namespace Odin.Hosting.Tests._Universal.Peer.PeerAppPushNotifications;
...
public class PeerAppPushNotificationTests
{
    ...
    public async Task CanSubscribeToPeerPushNotification(IApiClientContext callerContext,
    ...
    [TestCaseSource(nameof(AppWithOnlyUseTransitWrite))]
    [TestCaseSource(nameof(GuestNotAllowed))]
    public async Task CanUnsubscribeFromPeerPushNotification(IApiClientContext callerContext,
        HttpStatusCode expectedStatusCode)
    {
        await Task.CompletedTask;
    }
