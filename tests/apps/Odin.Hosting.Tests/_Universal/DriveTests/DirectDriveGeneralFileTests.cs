...
public class DirectDriveGeneralFileTests
{
    ...
    public static IEnumerable TestCases()
    {
        ...
        yield return new object[] { new AppWriteOnlyAccessToDrive(TargetDrive.NewTargetDrive()), HttpStatusCode.Accepted };
        yield return new object[] { new OwnerClientContext(TargetDrive.NewTargetDrive()), HttpStatusCode.Accepted };
    }
