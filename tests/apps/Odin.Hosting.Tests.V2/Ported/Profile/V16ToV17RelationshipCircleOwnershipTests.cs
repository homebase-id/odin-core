...
/// circles -- has them rebound by the v16 → v17 migration.</item>
/// </list>
...
/// </summary>
[TestFixture]
public class V16ToV17RelationshipCircleOwnershipTests : V2Fixture
{
    [Test]
    ...
    public async Task V17_BindsAllFourRelationshipCircles_ToTheChatApp()
    {
        ...
        var migration = scope.Resolve<V16ToV17VersionMigrationService>();
