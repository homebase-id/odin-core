...
namespace Odin.Core.Storage.Tests.IdentityDatabaseTests
{
    public class TableInboxTests
    {
        ...
        public void InsertRowTest()
        {
            ...
            db.tblInbox.Insert(new InboxRecord() { driveId = driveId, fileId = f1, priority = 0, value = v1 , sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = driveId, fileId = f2, priority = 10, value = v2, sender = "" });
            var tshi = UnixTimeUtc.Now();

            var r = db.tblInbox.Get(driveId, f1);
        ...
        public void PopTest()
        {
            ...
            var tslo = UnixTimeUtc.Now();
            db.tblInbox.Insert(new InboxRecord() { driveId = driveId, fileId = f1, priority = 0, value = v1, sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = driveId, fileId = f2, priority = 1, value = v2, sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = driveId, fileId = f3, priority = 2, value = v3, sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = driveId, fileId = f4, priority = 3, value = v4, sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = driveId, fileId = f5, priority = 4, value = v5, sender = "" });
            var tshi = UnixTimeUtc.Now();
            ...
            var r = db.tblInbox.PopSpecificBox(driveId, 1);
            ...
            r = db.tblInbox.PopSpecificBox(driveId, 10);
            if (r.Count != 4)
                Assert.Fail();
            ...
            r = db.tblInbox.PopSpecificBox(driveId, 1);
            if (r.Count != 0)
                Assert.Fail();
        }
        ...
        public void PopCancelTest()
        {
            ...
            db.tblInbox.Insert(new InboxRecord() { driveId = driveId, fileId = f1, priority = 0, value = null, sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = driveId, fileId = f2, priority = 0, value = null, sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = driveId, fileId = f3, priority = 10, value = null , sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = driveId, fileId = f4, priority = 10, value = null , sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = driveId, fileId = f5, priority = 20, value = null , sender = "" });

            var r1 = db.tblInbox.PopSpecificBox(driveId, 2);
            var r2 = db.tblInbox.PopSpecificBox(driveId, 3);

            db.tblInbox.PopCancelAll((Guid) r1[0].popStamp);

            var r3 = db.tblInbox.PopSpecificBox(driveId, 10);
            ...
            var r4 = db.tblInbox.PopSpecificBox(driveId, 10);
        ...
        public void PopCommitTest()
        {
            ...
            var r2 = db.tblInbox.PopSpecificBox(driveId, 10);
            if (r2.Count != 3)
                Assert.Fail();
        }
        ...
        public void PopCommitListTest()
        {
            ...
            db.tblInbox.Insert(new InboxRecord() { driveId = b1, fileId = f1, priority = 0, value = v1, sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = b1, fileId = f2, priority = 10, value = v1, sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = b1, fileId = f3, priority = 10, value = v1, sender = "" });
        ...
        public void DualBoxTest()
        {
            ...
            db.tblInbox.Insert(new InboxRecord() { driveId = b1, fileId = f1, priority = 0, value = v1, sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = b1, fileId = f2, priority = 10, value = v1, sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = b2, fileId = f3, priority = 10, value = v1 , sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = b2, fileId = f4, priority = 10, value = v1 , sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = b2, fileId = f5, priority = 10, value = v1 , sender = "" });
        ...
        public void ExampleTest()
        {
            ...
            db.tblInbox.Insert(new InboxRecord() { driveId = box1id, fileId = f1, priority = 0, value = v1, sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = box1id, fileId = f2, priority = 10, value = v2 , sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = box1id, fileId = f3, priority = 10, value = v3 , sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = box2id, fileId = f4, priority = 10, value = v4 , sender = "" });
            db.tblInbox.Insert(new InboxRecord() { driveId = box2id, fileId = f5, priority = 10, value = v5 , sender = "" });
