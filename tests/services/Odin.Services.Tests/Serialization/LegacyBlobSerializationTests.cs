...
///
/// Regenerate the fixtures with the [Explicit] GenerateFixtures test at the bottom.
/// </summary>
[TestFixture]
public class LegacyBlobSerializationTests
{
    ...
    public void GenerateFixtures()
    {
        ...
        Print("IcrAccessRecord", icrAccessRecord);
    ...
    private static void Print<T>(string name, T value)
    {
        ...
        Console.WriteLine(OdinSystemSerializer.Serialize(value));
    }
}
