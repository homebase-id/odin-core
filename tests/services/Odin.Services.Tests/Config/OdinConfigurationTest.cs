...
public class OdinConfigurationTest
{
    ...
    public void EmailSection_DefaultsToProviderNone()
    {
        ...
        Assert.That(section.MailgunCredentialsInOldConfigLocation, Is.False);
    ...
    [Test]
    public void EmailSection_OldMailgunLocation_MapsToMailgunProvider()
    {
        ...
        Assert.That(section.MailgunCredentialsInOldConfigLocation, Is.True);
        Assert.That(section.Provider, Is.EqualTo(EmailProvider.Mailgun));
        Assert.That(section.IsProviderConfigured, Is.True);
    ...
    [Test]
    public void EmailSection_DkimStorageKey_IsEmptyWhenMailgunIsInOldLocation()
    {
