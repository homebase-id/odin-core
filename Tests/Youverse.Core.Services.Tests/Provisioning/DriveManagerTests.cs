...
namespace Youverse.Core.Services.Tests.Provisioning
{
    ...
    public class DriveManagerTests
    {
        ...
        {
            var driveManager = new DriveService(_scaffold.Context, _scaffold.SystemStorage, _scaffold.LoggerFactory, _scaffold.Mediator, _scaffold.DriveAclAuthorizationService);
