...
namespace Youverse.Core.Services.Tests.DriveIndexerTests
{
    ...
    public class TableAclIndexTests
    {
        ...
        {
            var db = new DriveIndexDatabase("URI=file:.\\tblaclindex1.db", DatabaseIndexKind.Random);
            db.CreateDatabase();
        ...
        {
            var db = new DriveIndexDatabase("URI=file:.\\tblaclindex2.db", DatabaseIndexKind.Random);
            db.CreateDatabase();
        ...
        {
            var db = new DriveIndexDatabase("URI=file:.\\tblaclindex3.db", DatabaseIndexKind.Random);
            db.CreateDatabase();
        ...
        {
            var db = new DriveIndexDatabase("URI=file:.\\tblaclindex4.db", DatabaseIndexKind.Random);
            db.CreateDatabase();
        ...
        {
            var db = new DriveIndexDatabase("URI=file:.\\tblaclindex5.db", DatabaseIndexKind.Random);
            db.CreateDatabase();
        ...
        {
            var db = new DriveIndexDatabase("URI=file:.\\tblaclindex6.db", DatabaseIndexKind.Random);
            db.CreateDatabase();
