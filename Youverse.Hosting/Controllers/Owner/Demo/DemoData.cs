...
namespace Youverse.Hosting.Controllers.Owner.Demo
{
    public class DemoDataGenerator
    {
        ...
        public async Task SetProfiles()
        {
            ...
            BasicProfileInfo publicProfile = null;
            BasicProfileInfo privateProfile = null;

            if (IsFrodo)
            {
                primaryName = new NameAttribute() {Personal = "Frodo", Surname = "Baggins"};
                publicProfile = new BasicProfileInfo()
                {
                ...
                privateProfile = new BasicProfileInfo()
                {
                    Name = new NameAttribute()
                    {
                        Personal = "Frodo",
            ...
            await _attributeManagementService.SavePublicProfile(publicProfile.Name, publicProfile.Photo);
            await _attributeManagementService.SaveConnectedProfile(privateProfile.Name, publicProfile.Photo);
        }
