        ...
        public async Task SetProfiles()
        {
            ...
            if (IsFrodo)
            {
                ...
                publicProfile = new OwnerProfile()
                {
                    ...
                    Photo = new PictureAttribute()
                    {
                        Picture = "https://i2.wp.com/a1.ec-images.myspacecdn.com/images01/20/849847696a4b587b3e848eddd93c207e/l.jpg?zoom=2"
                    }
                };
                ...
                privateProfile = new OwnerProfile()
                {
                    ...
                    Photo = new PictureAttribute()
                    {
                        Picture = "https://img.huffingtonpost.com/asset/5d022ceb240000300f8d12bb.jpeg?ops=scalefit_720_noupscale"
                    }
                };
            }
            ...
            if (IsSam)
            {
                ...
                publicProfile = new OwnerProfile()
                {
                    ...
                    Photo = new PictureAttribute()
                    {
                        Picture = "https://static.wikia.nocookie.net/middle-earth-film-saga/images/5/52/Sam_TTT_profile.png/revision/latest?cb=20190727211735"
                    }
                };
                ...
                privateProfile = new OwnerProfile()
                {
                    ...
                    Photo = new PictureAttribute()
                    {
                        Picture = "https://miro.medium.com/max/640/0*tEUhip6Bfy-dDZSD"
                    }
                };
            }
            ...
            if (IsGandalf)
            {
                ...
                privateProfile = new OwnerProfile()
                {
                    ...
                    Photo = new PictureAttribute()
                    {
                        Picture = "https://static.wikia.nocookie.net/lotr/images/7/70/Gandalf%3B_The_White.jpg/revision/latest/scale-to-width-down/250?cb=20140110102343"
                    }
                };
            }
            ...
            if (IsOdin)
            {
                ...
                publicProfile = new OwnerProfile()
                {
                    ...
                    Photo = new PictureAttribute()
                    {
                        Picture = "https://static.wikia.nocookie.net/da27b848-42dd-4a68-933a-2ff32ed33895/scale-to-width/755"
                    }
                };
                ...
                privateProfile = new OwnerProfile()
                {
                    ...
                    Photo = new PictureAttribute()
                    {
                        Picture = "https://www.majesticdragonfly.com/image/cache/catalog/veronese/odin-with-ravens-norse-god-bust-statue-WU77529A4-900x900.jpg"
                    }
                };
            }
