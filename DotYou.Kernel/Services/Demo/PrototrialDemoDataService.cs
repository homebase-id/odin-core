...
namespace DotYou.Kernel.Services.Demo
{
    public class PrototrialDemoDataService : DotYouServiceBase, IPrototrialDemoDataService
    {
        ...
        public async Task SetPublicProfile()
        {
        ...
        private bool IsFrodo => this.Context.DotYouId == "frodobaggins.me";
        private bool IsSam => this.Context.DotYouId == "samwisegamgee.me";
        private bool IsGandalf => this.Context.DotYouId == "gandalf.middleearth.life";
        private bool IsOdin => this.Context.DotYouId == "odin.valhalla.com";
    }
}