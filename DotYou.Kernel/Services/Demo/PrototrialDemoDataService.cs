    ...
    public class PrototrialDemoDataService : DotYouServiceBase, IPrototrialDemoDataService
    {
        ...
        public async Task<bool> AddDigitalIdentities()
        {
            if (IsFrodo)
            {
                ...
                await _profileService.Save(new HumanProfile() {DotYouId = (DotYouIdentity) "gandalf.middleearth.life", Name = new NameAttribute() {Personal = "Olorin", Surname = "Maiar"}});
                await _profileService.Save(new HumanProfile() {DotYouId = (DotYouIdentity) "odin.valhalla.com", Name = new NameAttribute() {Personal = "Odin", Surname = "Rune Bringer"}});
            }
            ...
            if (IsGandalf)
            {
                await _profileService.Save(new HumanProfile() {DotYouId = (DotYouIdentity) "frodobaggins.me", Name = new NameAttribute() {Personal = "Frodo", Surname = "Baggins"}});
                await _profileService.Save(new HumanProfile() {DotYouId = (DotYouIdentity) "samwisegamgee.me", Name = new NameAttribute() {Personal = "Samwise", Surname = "Gamgee"}});
                await _profileService.Save(new HumanProfile() {DotYouId = (DotYouIdentity) "odin.valhalla.com", Name = new NameAttribute() {Personal = "Odin", Surname = "Rune Bringer"}});
            }
