    ...
    public class PrototrialDemoDataService : DotYouServiceBase, IPrototrialDemoDataService
    {
        ...
        public async Task<bool> AddDigitalIdentities()
        {
            if (IsFrodo)
            {
                ...
                await _profileService.Save(new HumanProfile() {Id = (DotYouIdentity) "gandalf.middleearth.life", Name = new NameAttribute() {Personal = "Olorin", Surname = "Maiar"}});
                await _profileService.Save(new HumanProfile() {Id = (DotYouIdentity) "odin.valhalla.com", Name = new NameAttribute() {Personal = "Odin", Surname = "Rune Bringer"}});
            }
            ...
            if (IsGandalf)
            {
                await _profileService.Save(new HumanProfile() {Id = (DotYouIdentity) "frodobaggins.me", Name = new NameAttribute() {Personal = "Frodo", Surname = "Baggins"}});
                await _profileService.Save(new HumanProfile() {Id = (DotYouIdentity) "samwisegamgee.me", Name = new NameAttribute() {Personal = "Samwise", Surname = "Gamgee"}});
                await _profileService.Save(new HumanProfile() {Id = (DotYouIdentity) "odin.valhalla.com", Name = new NameAttribute() {Personal = "Odin", Surname = "Rune Bringer"}});
            }
        ...
        public async Task SetProfiles()
        {
            ...
            ConnectedOwnerProfile connectedOwnerProfile = null;
            ...
            if (IsFrodo)
            {
                ...
                connectedOwnerProfile = new ConnectedOwnerProfile()
                {
                    Name = new NameAttribute()
                    {
                        Personal = "Frodo",
            ...
            await _admin.SavePublicProfile(ownerProfile);
            await _admin.SaveConnectedProfile(connectedOwnerProfile);
        }
