...
namespace DotYou.Kernel.Services.Demo
{
    public class PrototrialDemoDataService : DotYouServiceBase, IPrototrialDemoDataService
    {
        ...
        public PrototrialDemoDataService(DotYouContext context, ILogger logger, IContactService contactService, IAdminIdentityAttributeService admin) : base(context, logger, null, null)
        {
