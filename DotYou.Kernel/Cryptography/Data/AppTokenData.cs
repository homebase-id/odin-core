...
namespace DotYou.Kernel.Services.Admin.Authentication
{
    public class AppTokenData
    {
        ...
        public byte[] aDekXoredAdek; // The Application DeK encrypted with the Application KeK i.e. (ADeK ^ AKeK)
        public byte[] kekAesAdek;    // The application KeK encrypted with the (login) KeK, i.e. aes(aKeK, KeK)
